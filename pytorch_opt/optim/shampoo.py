...
and reused (stale) in between. 1D/0D parameters and parameters
explicitly assigned to the fallback use AdamW. Oversized selected matrices
raise an error; increase the limit or route them explicitly.
"""
...
class Shampoo(Optimizer, DiagnosticsMixin):
    def __init__(self, params, lr: float = 0.03, beta2: float = 0.999, eps: float = 1e-8,
        ...
        defaults = dict(lr=lr, beta2=beta2, eps=eps,
                        ...
                        use_preconditioner=None, adamw_lr=adamw_lr,
    ...
    def state_layout(cls) -> dict:
        return {"L": "replicable", "R": "replicable", "L_root": "replicable",
                ...
                "momentum_buffer": "shardable", "exp_avg": "shardable",
                "exp_avg_sq": "shardable"}
